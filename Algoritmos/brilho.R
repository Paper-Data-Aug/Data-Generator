...
#Este algoritmo gera novas imagens com o filtro de brilho
...
for(j in 1:nImagebrightness){
  for(i in 1:length(photographs)){
    ...
    png(file.path("D:/UFBA/IC/data generator/DATGenerator/Transformacoes/Brilho", 
